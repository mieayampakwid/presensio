...
| 02 | [People, Classes & Enrollment](02-people-classes.md) | v1.4 implemented 2026-09-19; **v2.0 (enrollment model) pending — ships with spec 08** |
| 03 | [Attendance Recording](03-attendance.md) | Implemented 2026-09-19; v2.5 amendment (sweep population) pending via spec 08 |
...
| 06 | [Reports & Exports](06-reports.md) | Implemented 2026-09-20; v1.5 amendment (year picker) pending via spec 08 |
| 07 | [Dashboard (Role Landing)](07-dashboard.md) | Draft — awaiting review; **sequenced after spec 08** |
| 08 | [Academic Roll-over & Historical Attribution](08-academic-years.md) | Draft v1.1 — next up |

## Build order

`01 → 02 → 03 → 04 → 05 → 06` shipped · next: `08 → 07 → deploy/pilot`

Spec 08 must ship **before go-live**: the enrollment model can be adopted cheaply only while no real attendance data exists.
